...
(function () {
  const TRANSLATIONS = {
    ...
    en: {
      ...
      // Login / Register
      loginTitle:             'Log In',
      loginDesc:              'Log in to see your family tree',
      registerTitle:          'Create Account',
      registerDesc:           'Sign up to start your own family tree',
      phUsername:             'Username',
      phPassword:             'Password',
      ...
      btnRegister:            'Sign Up',
      btnLogout:              'Log Out',
      loginToggleQuestion:    "Don't have an account?",
      loginToggleAction:      'Sign up',
      registerToggleQuestion: 'Already have an account?',
      registerToggleAction:   'Log in',
      loginErrorInvalidUsername: 'Username must be 3-20 characters: letters, numbers, underscore only',
      loginErrorPasswordLen:  'Password must be at least 6 characters',
      loginErrorPasswordMismatch: 'Passwords do not match',
      loginErrorRateLimited:  'Too many attempts — try again later',
      loginErrorUsernameTaken: 'That username is already taken',
      loginErrorWrongCreds:   'Incorrect username or password',
      loginErrorGeneric:      'Could not connect — try again',
      // Header
    ...
    vi: {
      ...
      loginDesc:              'Đăng nhập để xem cây gia phả của bạn',
      registerTitle:          'Tạo Tài Khoản',
      registerDesc:           'Đăng ký để bắt đầu cây gia phả của riêng bạn',
      phUsername:             'Tên đăng nhập',
      phPassword:             'Mật khẩu',
      phPasswordConfirm:      'Xác nhận mật khẩu',
      btnLogin:               'Đăng Nhập',
      btnRegister:            'Đăng Ký',
      btnLogout:              'Đăng Xuất',
      loginToggleQuestion:    'Chưa có tài khoản?',
      loginToggleAction:      'Đăng ký',
      registerToggleQuestion: 'Đã có tài khoản?',
      registerToggleAction:   'Đăng nhập',
      loginErrorInvalidUsername: 'Tên đăng nhập phải dài 3-20 ký tự: chữ, số, hoặc dấu gạch dưới',
      loginErrorPasswordLen:  'Mật khẩu phải có ít nhất 6 ký tự',
      loginErrorPasswordMismatch: 'Mật khẩu xác nhận không khớp',
      loginErrorRateLimited:  'Thử quá nhiều lần — vui lòng thử lại sau',
      loginErrorUsernameTaken: 'Tên đăng nhập này đã được sử dụng',
      loginErrorWrongCreds:   'Sai tên đăng nhập hoặc mật khẩu',
      loginErrorGeneric:      'Không thể kết nối — vui lòng thử lại',
      // Header
