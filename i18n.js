...
(function () {
  const TRANSLATIONS = {
    ...
    en: {
      ...
      loginErrorEmailTaken:   'An account with that email already exists',
      loginErrorWrongCreds:   'Incorrect email or password',
    ...
    vi: {
      ...
      loginErrorInvalidEmail: 'Vui lòng nhập email hợp lệ',
      ...
      loginErrorEmailTaken:   'Email này đã được đăng ký',
      loginErrorWrongCreds:   'Sai email hoặc mật khẩu',
