...
(function () {
  const TRANSLATIONS = {
    ...
    en: {
      ...
      syncDesc:              'This app has no login — each browser is identified by a private device ID. Copy yours into another browser, or paste one here to switch this browser to that data.',
      syncYourIdLabel:       'Your device ID',
      btnCopy:               'Copy',
      toastIdCopied:         'Device ID copied to clipboard',
      syncPasteLabel:        'Switch to another device ID',
      phDeviceId:            'Paste device ID…',
      btnSync:               'Sync',
      toastSyncInvalid:      "That doesn't look like a valid device ID",
      confirmSync:           (id) => `Switch this browser to device ID "${id}"?\nThis browser will then show that device's data instead of what you see now.`,
      // Person modal
    ...
    vi: {
      ...
      syncDesc:              'Ứng dụng này không có đăng nhập — mỗi trình duyệt được nhận diện bằng một mã thiết bị riêng. Sao chép mã của bạn sang trình duyệt khác, hoặc dán mã vào đây để chuyển trình duyệt này sang dữ liệu đó.',
      syncYourIdLabel:       'Mã thiết bị của bạn',
      btnCopy:               'Sao Chép',
      toastIdCopied:         'Đã sao chép mã thiết bị',
      syncPasteLabel:        'Chuyển sang mã thiết bị khác',
      phDeviceId:            'Dán mã thiết bị…',
      btnSync:               'Đồng Bộ',
      toastSyncInvalid:      'Mã thiết bị không hợp lệ',
      confirmSync:           (id) => `Chuyển trình duyệt này sang mã thiết bị "${id}"?\nTrình duyệt này sẽ hiển thị dữ liệu của thiết bị đó thay vì dữ liệu hiện tại.`,
      // Person modal
